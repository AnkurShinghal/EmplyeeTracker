...
const initialValues = {phone_number:"", name:"", family_name:"", password:"", email:"", user_name:"" }
            ...
            <ScrollView keyboardShouldPersistTaps= "always">
                ...
                >
                   ...
                   {(props)=>
                       <View style={styles.view2}>
                           <View>
                               <Text style={styles.text2}>New on EmployeeTracker?</Text>
                           </View>
                           ...
                           <View style ={styles.view6}>
                               ...
                               <View style={styles.view10}>
                                ...
                                <View style={styles.view14}>
                                    <Animatable.View
                                     animation={passwordFocussed? "fadeInRight":'fadeInLeft'} duration={400}
                                     >
                                       <Icon
                                          name="lock"
                                          color={colors.grey3}
                ...
                <View style={styles.view19}>
                    <View style={styles.view20}>
                       <Text style={styles.text6}>Already have an account with EmployeeTracker?</Text>
                    </View>
